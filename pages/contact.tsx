...
export const getServerSideProps: GetServerSideProps = async () => {
  ...
  if (maintenance) {
    ...
    var todaysDate = moment(new Date()); // moment("2016-06-06T21:03:55")
    var expectedEndDate = moment(endDate);

    // const minutes = b.diff(a, "minutes"); // 44700
    // const hours = b.diff(a, "hours"); // 745
    // const days = b.diff(a, "days"); // 31
    const weeks = expectedEndDate.diff(todaysDate, "weeks"); // 4
    const diff_s = expectedEndDate.diff(todaysDate, "seconds");
    // console.log()
    const date = moment
