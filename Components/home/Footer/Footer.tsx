...
const Footer = () => (
  <>
    <div
      className="container-fluid bg-dark text-white-50 py-5 px-sm-3 px-lg-5 mt-[90px]"
    >
        ...
        <div className="col-lg-3 col-md-6 mb-5">
          ...
          <div className="w-100">
            <div className="input-group">
              <input
                type="text"
                className="form-control border-light p-[25px]"
    ...
    <div className="container-fluid bg-dark text-white border-top py-4 px-sm-3 px-md-5 border-[rgba(256, 256, 256, .1) !important]">
      <div className="row">
